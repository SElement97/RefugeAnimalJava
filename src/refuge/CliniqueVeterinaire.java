...
public class CliniqueVeterinaire implements Serializable {
    ...
    public CliniqueVeterinaire() {
        ...
        telephone = "555-1234";
        typeDeSoin = TypeDeSoin.CONSULTATION_GENERALE;

        nomsVeterinaires = new ArrayList<>(Arrays.asList("Dr. Dupont", "Dr. Lefebvre"));
    }

    // Constructeur avec paramètres
    public CliniqueVeterinaire(String unNomClinique, String uneAdresse, String unTelephone,
                               TypeDeSoin unTypeDeSoin, ArrayList<String> desVeterinaires) {
    ...
    public ArrayList<String> getNomsVeterinaires() {
        return nomsVeterinaires;
    }

    // Setters

    public void setNomClinique(String unNomClinique) {
        nomClinique = unNomClinique;
    }
    ...
    public void setTypeDeSoin(TypeDeSoin unTypeDeSoin) {
        typeDeSoin = unTypeDeSoin;
    }
    ...
    public String toString() {
        return "Clinique Vétérinaire: " + nomClinique +
                ", Adresse: " + adresse +
                ", Téléphone: " + telephone +
                ", Type de soin: " + typeDeSoin +
                ", Vétérinaires: " + nomsVeterinaires;
    }
}
